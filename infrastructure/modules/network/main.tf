# 2 public subnets (2 AZs — the ALB requires at least two) + 1 private
# subnet (single-AZ — ECS tasks and RDS, a deliberate cost trade-off, see
# project-ecs-over-apprunner-decision). Single NAT Gateway, not one per AZ.
